...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-ot-zy80.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-ot-zy80.containers.anotherwebservice.com/
...
```
git clone git@github.com:oudi1999/container-ot-zy80.git
cd container-ot-zy80
```
...
```
docker attach container-ot-zy80
```
